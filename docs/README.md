...
| Document | Read it to… |
| --- | --- |
| [Development](development/development.md) | Find your way around the code, run every command, package the desktop app and build the demo container. |
...
| [v2.2 implementation report](development/v2.2-release-report.md) | Review cloud sync scope, test evidence, and remaining deployment work. |
